...
<div class="border border-secondary p-2 mb-3">
  ...
  <span class="d-block h5">{{ $pref_name }} {{ $city_street_kw }} の検索結果</span>
</div>
...
<ul class="d-flex flex-column">
  ...
  <li class="p-2 d-flex">
    <a class="d-block w-25" href="{{ route('streets_from_city', ['pref_name' => $address->pref, 'city_name' => $address->city]) }}">{{ $address->city }}</a>
